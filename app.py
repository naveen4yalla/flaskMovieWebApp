...
def tvshowsearch(id):
    ...
    url="https://api.themoviedb.org/3/genre/tv/list?api_key={}&language=en-US".format(api_key)
    re=requests.get(url)
    genre=re.json()
    genre_list = {}
    genresid=""
...
def multishowsearch(id):
    ...
    urltv="https://api.themoviedb.org/3/genre/tv/list?api_key={}&language=en-US".format(api_key)
    re=requests.get(urltv)
    genretv=re.json()

    urlmovie="https://api.themoviedb.org/3/genre/movie/list?api_key={}&language=en-US".format(api_key)
